...
class BannerImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(padding: EdgeInsets.only(left: 12),child: Text("배너 이미지 추가",style: AppTextStyles.blackColorH2Bold),),
            SizedBox(height: 12),
            if(bannerProvider.banner != null)...[
              GestureDetector(
                ...
                child: imageHelper(context, bannerProvider.banner),
              ),
            ]else...[
              InkWell(
  ...
  Widget imageHelper(BuildContext context, url) {
    return  SizedBox(
